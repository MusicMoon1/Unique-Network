import { Box, Button, Checkbox, CircularProgress, Divider, FormControl, Grid, InputLabel, ListItemText, MenuItem, OutlinedInput, Select, Typography, useMediaQuery } from '@mui/material'
                        ...
                        <div style={{ width: isMobile ? "350px" : "525px", height: "336px", }}>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between" }}>
                                <InputField
                                    ...
                                    labelfontSize="12px"
                                />
                                <FormControl sx={{ width: "350px", marginTop: "14px", marginLeft: "10px" }}>
                                    <label htmlFor="" style={{ color: theme.colors.textcolor }}>Category</label>
                                    <Select
